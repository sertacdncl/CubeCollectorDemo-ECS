...
public partial class ConfigContext {
    ...
    public ConfigEntity SetLevelConfig(ILevelConfig newValue) {
        if (hasLevelConfig) {
    ...
    public void ReplaceLevelConfig(ILevelConfig newValue) {
...
public partial class ConfigEntity {
    ...
    public void AddLevelConfig(ILevelConfig newValue) {
