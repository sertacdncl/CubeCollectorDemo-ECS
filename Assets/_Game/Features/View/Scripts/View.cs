    ...
    , IScaleListener
{
    ...
    public void OnRotation(GameEntity entity, Vector2Int value) => transform.localRotation = Quaternion.Euler(value.x, value.y, transform.localRotation.eulerAngles.z);
