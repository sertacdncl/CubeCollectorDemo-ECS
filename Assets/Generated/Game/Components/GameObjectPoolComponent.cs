...
public partial class GameEntity {
    ...
    public void AddObjectPool(string newId, DesperateDevs.Caching.ObjectPool<IView> newValue) {
    ...
    public void ReplaceObjectPool(string newId, DesperateDevs.Caching.ObjectPool<IView> newValue) {
        var index = GameComponentsLookup.ObjectPool;
        var component = (ObjectPoolComponent)CreateComponent(index, typeof(ObjectPoolComponent));
        component.Id = newId;
        component.Value = newValue;
